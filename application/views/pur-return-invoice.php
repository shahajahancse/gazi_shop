    ...
    <section class="invoice">
        ...
        <div class="printableArea">
            ...
            <div class="col-xs-12 table-responsive">
              <table class="table table-striped records_table table-bordered">
                ...
                <?php
                  $i=0;
                  $tot_total_cost=0;
                  $q2=$this->db->query("SELECT c.item_name, a.* FROM db_purchaseitemsreturn AS a,db_items AS c WHERE c.id=a.item_id AND a.return_id='$return_id'");
                  foreach ($q2->result() as $res2) {
                    echo "<tr>";
                      echo "<td>".++$i."</td>";
                      echo "<td>".$res2->item_name."</td>";
                      echo "<td>".$CI->currency($res2->price_per_unit)."</td>";
                      echo "<td>".$res2->return_box."</td>";
                      echo "<td>".$res2->return_pieces."</td>";
                ...
                <tfoot class="text-right text-bold bg-gray">
                  <tr>
                    <td colspan="2" class="text-right"><?= $this->lang->line('total'); ?></td>
                    <td colspan="4"></td>
                    <td class="text-right"><?= $CI->currency(number_format($tot_total_cost,2,'.','')) ;?></td>
                  </tr>
                </tfoot>
              </table>
            </div>
                    ...
                    <div class="form-group">
                        <table  class="col-md-11">
                          ...
                          <tr>
                              ...
                              <th class="text-right" style="padding-left:10%;font-size: 17px;">
                                <h4><b id="total_amt" name="total_amt"><?=$CI->currency($tot_total_cost);?></b></h4>
                              </th>
                          </tr>
                        </table>
                    </div>
          ...
          <div class="row no-print">
            <div class="col-xs-12">
                <a href="<?php echo $base_url; ?>purchase_return/print_invoice/<?php echo  $return_id ?>" target="_blank" class="btn btn-warning"> <i class="fa fa-print"></i> Print </a>
                <a href="<?php echo $base_url; ?>purchase_return/pdf/<?php echo  $return_id ?>" target="_blank" class="btn btn-primary"> <i class="fa fa-file-pdf-o"></i> PDF </a>
            </div>
          </div>
        </div>
    </section>
