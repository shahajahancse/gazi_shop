...
<body class="hold-transition skin-blue sidebar-mini">
   ...
   <script>
      ...
      function cal_qty_price(i){
         ...
         var p_price = (isNaN(parseFloat($("#td_data_"+i+"_7").val()))) ? 0 :parseFloat($("#td_data_"+i+"_7").val());
         var h_price = (isNaN(parseFloat($("#td_data_"+i+"_11").val()))) ? 0 :parseFloat($("#td_data_"+i+"_11").val());
