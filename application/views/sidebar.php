    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="pos-active-li sales-list-active-li sales-active-li sales-return-active-li sales-return-list-active-li treeview">
            ...
            <li class="sales-return-list-active-li sales-return-active-li"><a href="<?php echo $base_url; ?>sales_return"><i class="fa fa-list "></i> <span><?= $this->lang->line('sales_returns_list'); ?></span>
            <span class="pull-right-container">
        ...
        <?php if($CI->permissions('items_add') || $CI->permissions('items_view') || $CI->permissions('items_category_add') || $CI->permissions('items_category_view') || $CI->permissions('brand_add') || $CI->permissions('brand_view') || $CI->permissions('print_labels')) { ?>
          <li class="items-list-active-li items-active-li  category-view-active-li category-active-li brand-active-li brand-view-active-li labels-active-li treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li class="brand-active-li">
                <a href="<?php echo $base_url; ?>brands/company_add"><i class="fa fa-plus-square-o "></i>
                  <span><?= $this->lang->line('new_brand_company'); ?></span>
                  <span class="pull-right-container">
                    <small class="label pull-right bg-green">new</small>
                  </span>
                </a>
              ...
              <li class="brand-view-active-li"><a href="<?php echo $base_url; ?>brands/company_view"><i class="fa fa-list "></i> <span><?= $this->lang->line('brand_company_list'); ?></span></a></li>
        ...
        <?php if($change_password=true) { ?>
          <li class=" company-profile-active-li site-settings-active-li  change-pass-active-li dbbackup-active-li warehouse-active-li warehouse-list-active-li tax-active-li currency-view-active-li currency-active-li  database_updater-active-li tax-list-active-li units-list-active-li unit-active-li payment_types_list-active-li payment_types-active-li treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li class="payment_types_list-active-li payment_types-active-li"><a href="<?php echo $base_url; ?>payment_types/"><i class="fa fa-list "></i> <span><?= $this->lang->line('payment_types_list'); ?></span>
              <span class="pull-right-container">
                    <small class="label pull-right bg-green">new</small>
                  </span>
                </a></li>
