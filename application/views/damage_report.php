...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <section class="content hide_print">
      <div class="row">
        <!-- right column -->
        <div class="col-md-12">
          <!-- Horizontal Form -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <div class="input-group date">
                      ...
                      <input onchange="update_date()" type="text" class="form-control pull-right datepicker" id="from_date" name="from_date" value="<?php echo show_date(date('d-m-Y'));?>" readonly>
                    </div>
                  ...
                  <div class="col-sm-3">
                    <div class="input-group date">
                      <div class="input-group-addon"> <i class="fa fa-calendar"></i> </div>
                      <input onchange="update_date()" type="text" class="form-control pull-right datepicker" id="to_date" name="to_date" value="<?php echo show_date(date('d-m-Y'))?>" readonly>
                    </div>
                    <span id="Sales_date_msg" style="display:none" class="text-danger"></span>
                  </div>
                </div>
  ...
  <div class="control-sidebar-bg hide_print"></div>
</div>
<!-- ./wrapper -->
