  ...
  <table align="center" width="100%" height='100%'>
    <thead>
      <tr>
        ...
        <th colspan="3" rowspan="1"><b style="text-transform: capitalize;"><?= $this->lang->line('sales_invoice'); ?> </b>(<?=$return_status;?>)</th>
      </tr>
      <tr>
        <th rowspan="1">
    ...
    <tfoot>
      ...
      <tr>
        ...
        <td colspan="1" style="text-align: right;" ><b><?php echo number_format($total_cost,2,'.',''); ?></b></td>
      </tr>
      <tr>
        <td colspan="8">
        <?php
