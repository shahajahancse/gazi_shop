...
class Suppliers_model extends CI_Model {
	...
	var $column_order = array('a.id','a.supplier_name','a.mobile','a.email','a.opening_balance','a.purchase_due','a.purchase_return_due','a.status'); //set column field database for datatable orderable
	var $column_search = array('a.id','a.supplier_name','a.mobile','a.email','a.opening_balance','a.purchase_due','a.purchase_return_due','a.status'); //set column field database for datatable searchable 
        ...
        while($amount>0) {
          ...
          if($amount<=$supplier_purchase_return_due){
            ...
            foreach ($qs4->result() as $res) {
              ...
              $q10=$this->purchase_return_model->update_purchase_payment_status($return_id);
            if($q10!=1){
              return "failed";
            }
            }
