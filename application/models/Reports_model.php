	...
	public function get_profit_by_item(){
		...
		if($q1->num_rows()>0){
			...
			foreach ($q1->result() as $res1) {
				...
				echo "<td>".$res1->item_name."</td>";
				echo "<td>".$qty."</td>";
				echo "<td style='text-align:right;'>".$CI->currency(number_format($purchase_price,2,'.',''))."</td>";
				echo "<td style='text-align:right;'>".$CI->currency($total_cost)."</td>";
				/*echo "<td style=''>".$purchase_return_qty."</td>";
				echo "<td style='text-align:right;'>".$CI->currency(number_format($purchase_return_price,2,'.',''))."</td>";*/
				/*echo "<td style=''>".$sales_return_qty."</td>";
				echo "<td style='text-align:right;'>".$CI->currency($sales_return_total_cost)."</td>";*/
				echo "<td style='text-align:right;'>".$CI->currency(number_format($profit,2,'.',''))."</td>";
				echo "<td style='text-align:right;'>".$CI->currency(number_format($net_profit,2,'.',''))."</td>";
				echo "</tr>";
			...
			echo "<tr>
				  ...
				  /*<td class='text-bold'>".$tot_purchase_return_qty."</td>
					  <td class='text-right text-bold'>".$CI->currency(number_format($tot_purchase_return_price,2,'.',''))."</td>
					  <td class='text-bold'>".$tot_sales_return_qty."</td>
					  <td class='text-right text-bold'>".$CI->currency(number_format($tot_sales_return_cost,2,'.',''))."</td>
					  */
		}
		else{
			echo "<tr>";
	...
	public function get_profit_by_invoice(){
		...
		if($q1->num_rows()>0){
			...
			foreach ($q1->result() as $res1) {
				...
				echo "<td>".show_date($res1->sales_date)."</td>";
				echo "<td>".$res1->customer_name."</td>";
				echo "<td style='text-align:right;'>".$CI->currency($purchase_price)."</td>";
				echo "<td style='text-align:right;'>".$CI->currency($sales_price)."</td>";
				echo "<td style='text-align:right;'>".$CI->currency(number_format($profit,2,'.',''))."</td>";
				//echo "<td style='text-align:right;'>".$CI->currency(number_format($net_profit,2,'.',''))."</td>";
				echo "</tr>";
				$tot_purchase_price+=$purchase_price;
